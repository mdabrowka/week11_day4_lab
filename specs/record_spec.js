...
it('record should return properties as a string', function () {
  assert.strictEqual(record.propertiesToString(), "Artist: Pink Floyd, title: Dark Side of the Moon, genre: rock, price: 7");
})
